...
class account_invoice(osv.osv):
    ...
    def _amount_in_words(self, cr, uid, ids, field_name, arg, context=None):
        ...
        for inv in self.browse(cr, uid, ids, context=context):
            ...
            res[inv.id] = amount_to_text_ar(inv.amount_total, inv.currency_id.symbol)
        return res
...
class sale_order(osv.osv):
    ...
    def _amount_in_words(self, cr, uid, ids, field_name, arg, context=None):
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            res[order.id] = amount_to_text_ar(order.amount_total, order.pricelist_id.currency_id.symbol)
        return res

    _columns = {
        'amount_to_text': fields.function(_amount_in_words, string='In Words', type="char", store=True,
